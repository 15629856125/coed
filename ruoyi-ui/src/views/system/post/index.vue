<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科室编码" align="center" prop="postCode" />
      <el-table-column label="科室名称" align="center" prop="postName" />
      <el-table-column label="科室排序" align="center" prop="postSort" />
